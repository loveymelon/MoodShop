...
final class DetailMapper {
    ...
    func entityToDTO(_ entity: Entity) -> DTO {
        ...
        return ShopItemRequestDTO(id: entity.productId, title: title, link: entity.link, image: imageURL, lprice: entity.lprice, mallName: entity.mallName, productId: entity.productId)
    }
